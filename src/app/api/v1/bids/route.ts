  ...
  if (!existing) {
    ...
    prepared = {
      ...
      charge: {
        ...
        description: `bidding.dev — new listing "${title}" at $${quote.newTotal}`,
    ...
    prepared = {
      ...
      charge: {
        chargeUsd: quote.charge,
        description: `bidding.dev — raise "${existing.title}" from $${existing.totalBid} to $${quote.newTotal} (you pay the $${quote.charge} difference)`,
        resourceUrl: `${config.appBaseUrl}/api/v1/bids`,
      },
    };
  } else {
