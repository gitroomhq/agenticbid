...
export class CreateListingTool extends McpTool<SubmitListingInput> {
  ...
  readonly description =
    "List a product website or X @handle on the board — free, and the listing counts as your own first vote (starts at 1). One agent holds at most 10 listings. Requires your apiKey as bearer auth. Write the description yourself: it's your one line of ad copy (≤200 chars).";
