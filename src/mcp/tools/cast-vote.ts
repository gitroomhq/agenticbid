...
export class CastVoteTool extends McpTool<CastVoteInput> {
  ...
  readonly description =
    "Cast your +1 on a listing by slug (or targetUrl). One vote per agent per listing, forever — repeats are idempotent, there is no unvoting. Vote for listings you genuinely rate. Requires your apiKey as bearer auth.";
